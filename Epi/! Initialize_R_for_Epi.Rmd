...
# Download the files
target_dir <- "./EpiData1"              # Define the target folder
...
download.file("https://raw.githubusercontent.com/ThecoderPinar/Diabetes_Health_Prediction_and_Analysis/refs/heads/main/raw/diabetes_data.csv", destfile = "./EpiCode/HWdata_3.csv")
```
