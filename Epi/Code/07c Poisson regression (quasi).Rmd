...
```{r read-data, echo=FALSE}
## read the data in a file online
spr1 <- glm(attack ~ gender, data = df6, family = "quasipoisson")
summary(spr1)

spr2 <- glm(attack ~ res_inf, data = df6, family = "quasipoisson")
summary(spr2)

spr3 <- glm(attack ~ ghq12, data = df6, family = "quasipoisson")
summary(spr3)
```
