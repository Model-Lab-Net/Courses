...
summary(qpr)
qpr_tbl <- tbl_regression(qpr, exponentiate = TRUE)
qpr_tbl
```
...
spr <- glm(ghq12 ~ ., data = df6, family = "poisson")
spr_tbl <- tbl_regression(spr, exponentiate = TRUE)

combined_tbl <- tbl_merge(
  tbls = list(spr_tbl, qpr_tbl),
