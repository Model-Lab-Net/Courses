...
attr(df5$perforation, "label") <- "ניקוד במעיים"
attr(df5$degree.perforation, "label") <- "חומרת ניקוד במעיים"
...
attr(df5$perforation.ord, "label") <- "חומרת ניקוד במעיים (במשתנה אורדינלי)"
