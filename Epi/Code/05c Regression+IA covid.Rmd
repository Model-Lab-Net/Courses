...
sw <- check_normality(mlrIA)                # Shapiro-Wilk for normality
bp <- check_heteroscedasticity(mlrIA)       # Breusch-Pagan for heteroscedacity
dw <- check_autocorrelation(mlrIA)          # Durbin-Watson test for autocorelation
