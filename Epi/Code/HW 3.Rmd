...
#file <- "lung.csv"     # use this if the file is on your computer
file <- "http://www-eio.upc.edu/~pau/cms/rdata/csv/survival/lung.csv"
...
# Kaplan-Meier survival estimate (no grouping)
